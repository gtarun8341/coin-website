...
function LoginPage() {
  ...
  <img src={logo} alt="Coin" className="mt-lg-3 mt-0" style={{ width: '50%', height: 'auto', marginBottom: '20px' }} />
        ...
        <p style={{ fontSize: '0.8rem', marginBottom: '20px' }}>with your TARGETCOIN Account</p>
        ...
        <p style={{ marginTop: '20px' }}>Don’t have an account? <span style={{ color: 'blue', cursor: 'pointer' }} onClick={() => navigate('/register')}>Sign up here</span></p>
      </div>
      <div className="col-lg-1 d-none d-lg-block">
      {/* This div will act as a column space */}
    </div>
